    ...
    public class CharacterMaster extends Character implements Serializable {
        ...
        public CharacterMaster(Character character, Attribute attribute, Currency currency, Folder folder, List<Inventory> inventory, Slots slots, List<Speech> speech, List<Spell> spells) {
